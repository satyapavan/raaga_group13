...
<h1>Edit Batch Schedule Success</h1>
<h:outputText value="#{batchDetailsMB.message}" styleClass="error"></h:outputText><br>


<a href="mailto:<%=(String)session.getAttribute("to") %>&Subject=Notification&Body=Hi%20All%0D<%=(String)session.getAttribute("msg")%>">Alert By Mail</a>
